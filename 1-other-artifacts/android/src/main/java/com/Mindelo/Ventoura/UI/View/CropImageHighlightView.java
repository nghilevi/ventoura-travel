...
public class CropImageHighlightView {
    ...
    public static final int CROPIMAGESIZE=ConfigurationConstant.SHRINK_USER_IMAGE_HEIGHT;

    public CropImageHighlightView(View ctx) {
        mContext = ctx;
    }
    ...
    protected void draw(Canvas canvas) {
        ...
        if (!hasFocus()) {
            ...
            if (mCircle) {
                ...
                mOutlinePaint.setColor(0xfff36b67);
            }
    ...
    void growBy(float dx, float dy) {
        ...
        RectF oldR=new RectF(mCropRect);
        ...
        if(mMaintainAspectRatio){
        	 //control the size of the cropimage
            if(r.bottom-r.top<CROPIMAGESIZE){
            	mCropRect.set(oldR);
            }else{
            	mCropRect.set(r);
            }

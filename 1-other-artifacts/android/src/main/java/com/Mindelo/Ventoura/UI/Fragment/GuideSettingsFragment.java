...
public class GuideSettingsFragment extends Fragment implements OnClickListener {

	private static final String TAG = "GuideSettingsFragment";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_guide_settings,
				container, false);

...
import com.Mindelo.Ventoura.Entity.RotateBitmap;
...
public abstract class CropImageViewTouchBase extends ImageView {
    ...
    public CropImageViewTouchBase(Context context) {
        super(context);
        init();
    }

    public CropImageViewTouchBase(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

...
- (void)setUpUI {
    ...
    //OS Specific:
    if (isIOS7) {
        self.barTintColor = [ventouraUtility ventouraPink];
...
//    self.backgroundColor = [ventouraUtility ventouraPink];
    //:::[For debugging]:::
//    self.containerView.backgroundColor = [ventouraUtility ventouraPink];

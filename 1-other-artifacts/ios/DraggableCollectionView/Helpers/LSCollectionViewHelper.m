...
- (void)handleLongPressGesture:(UILongPressGestureRecognizer *)sender
{
    ...
    switch (sender.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            UIImage *maskedImage = [self maskImage:[self imageFromCell:cell] withMask:mask];
//            userImage.img = maskedImage;
            mockCell.image = maskedImage;//does not copy transparency
...
//                 mockCell.transform = CGAffineTransformMakeScale(1.1f, 1.1f);
                 if (indexPath.row ==0) {
                     mockCell.transform = CGAffineTransformMakeScale(0.4f, 0.4f);
            ...
            self.lastSelectedIndexPathRow = indexPath.row;
...
//                 mockCell.transform = CGAffineTransformMakeScale(1.f, 1.f);
                 if (indexPath.row ==0) {
                     if (self.lastSelectedIndexPathRow ==0) {
                         mockCell.transform = CGAffineTransformMakeScale(1.0f, 1.0f);
                         
                     }else{
                         if([ventouraUtility isUserGuide]){
                             mockCell.transform = CGAffineTransformMakeScale(3.4f, 3.4f);
                         }else{
                             mockCell.transform = CGAffineTransformMakeScale(2.6f, 2.6f);
                     ...
                     if (self.lastSelectedIndexPathRow  ==0) {
                         if([ventouraUtility isUserGuide]){
                             mockCell.transform = CGAffineTransformMakeScale(0.28f, 0.28f);
                         }else{
                             mockCell.transform = CGAffineTransformMakeScale(0.37f, 0.37f);
                         }
                     }else{
                         mockCell.transform = CGAffineTransformMakeScale(1.0f, 1.0f);

...
- (void)addTag:(NSString*)text tagId:(NSString*)tagId
{
    [self addTag:text tagId:tagId andRearrange:YES];
}

- (void)addTag:(NSString*)text tagId:(NSString*)tagId andRearrange:(BOOL)rearrange
{

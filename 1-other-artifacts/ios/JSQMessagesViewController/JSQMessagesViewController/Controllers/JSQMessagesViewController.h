...
//ventoura emoticon value
@property (assign, nonatomic) BOOL emoticonViewVisible;
@property (assign, nonatomic) BOOL keyboardViewVisible;
...
@property ( nonatomic, readonly) JSQMessagesKeyboardController *keyboardController;

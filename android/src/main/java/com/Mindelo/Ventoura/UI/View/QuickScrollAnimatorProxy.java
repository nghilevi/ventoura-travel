 ...
 */
public final class QuickScrollAnimatorProxy extends Animation {
    ...
    private static final WeakHashMap<View, QuickScrollAnimatorProxy> PROXIES =
            new WeakHashMap<View, QuickScrollAnimatorProxy>();
     ...
     */
    public static QuickScrollAnimatorProxy wrap(View view) {
        QuickScrollAnimatorProxy proxy = PROXIES.get(view);
        // This checks if the proxy already exists and whether it still is the animation of the given view
        if (proxy == null || proxy != view.getAnimation()) {
            proxy = new QuickScrollAnimatorProxy(view);
    ...
    private QuickScrollAnimatorProxy(View view) {

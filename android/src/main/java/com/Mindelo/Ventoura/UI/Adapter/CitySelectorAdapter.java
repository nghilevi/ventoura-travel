...
public class CitySelectorAdapter extends BaseAdapter implements QuickScrollScrollable{
	...
	public CitySelectorAdapter(Context context, List<City> citylist) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.adapter_city_selector_item, null);
			holder = new ViewHolder();

			holder.tv_cityname = (TextView) convertView
					.findViewById(R.id.tv_city_selector_item_city);

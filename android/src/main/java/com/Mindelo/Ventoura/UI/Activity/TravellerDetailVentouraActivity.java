...
public class TravellerDetailVentouraActivity extends FragmentActivity {

	private static final String TAG = "TravellerDetailVentouraActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_traveller_detail_ventoura);
		 ...
		 */
		tv_about = (TextView) findViewById(R.id.traveller_detail_ventoura_description_tv);
		tv_name_age = (TextView) findViewById(R.id.traveller_detail_ventoura_name_age_tv);
		tv_country = (TextView) findViewById(R.id.traveller_detail_ventoura_country_tv);
		iv_countryFlag = (ImageView) findViewById(R.id.traveller_detail_ventoura_country_img);
	...
	private void setCommonFieldViews() {
		if (ventoura != null) {
			...
			Country country = countryService.getCountryById(ventoura
					.getCountry());
			if (country != null) {
	...
	private class LoadGalleyImageTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			pvAdapter = new ProfileSlideShowViewAdapter(
					getSupportFragmentManager(), entities);
